 use autheo_pqcnet_5dqeh::{
     FiveDqehSim, HypergraphState, QehConfig, SimulationIntent, TemporalWeightModel, VertexId,
 };
 ...
 fn main() {
     ...
     println!(
         "epoch {}: {} accepted, {} archived (coherence {:.2})",
         report.epoch_index, report.accepted_vertices, report.crystalline_archives, report.coherence_index
     );
